...
void loop()
{
  ...
  if (digitalRead(PIN_T3) == LOW)
  {
    ...
    {
      // Starte den Countdown für das ausgewählte Menü beim ersten Tastendruck
      unsigned long selectedTime = subMenuTimes[pos % MENU_ANZ];
      countDownActive = true;
      countDownStartTime = millis();
      countDownDuration = selectedTime * 1000;
    }
  }
